				...
				<div class="testimonial">
					...
					<div class="testimonial__text">
						<p>Nunc placerat mi id nisi interdum mollis. Praesent
							pharetra, justo ut scelerisque the mattis, leo quam aliquet diam
							congue is the laoreet elit metus. Nunc placerat mi is id nisi
							interdum is mollis. Praesent the pharetra, justo ut scelerisque.</p>
					</div>
				</div>
				<!-- end /.testimonial -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="feature">
					<%-- <div class="feature__img">
						<img src="<c:url value='/assest/template/images/feature1.png'/>"
							alt="feature" />
					</div> --%>
			...
			<div class="col-lg-4 col-md-6">
				<div class="feature">
					<%-- <div class="feature__img">
						<img src="<c:url value='/assest/template/images/feature2.png'/>"
							alt="feature" />
					</div> --%>
					<div class="feature__title">
